...
public class FTPCommunicationChannel {
	...
	/**
	 * The name of the charset that has to be used to encode and decode the communication.
	 */
	 ...
	 * @param charsetName The name of the charset that has to be used to encode and decode the communication.
